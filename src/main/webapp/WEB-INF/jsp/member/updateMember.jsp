...
<%@ include file="../member/mypage.jsp" %>
	...
	<form action="/member/updateMember" method="post" id="updateForm" enctype="multipart/form-data">
			...
			<div><input class="join_password" type="password" id="m_pw" name="m_pw"  onchange="chk_pattern_pw()" placeholder="비밀번호를 입력해주세요." required maxlength="20">
			<div id="m_pw_msg"></div>
			</div>
					

			<div style="font-weight:bold;">비밀번호 확인</div>
			<div><input class="join_password_chk" type="password" id="m_pw_chk" name="m_pw2" onchange="chk_pw()" placeholder="비밀번호 확인값을 입력해주세요." maxlength="20">
			...
			placeholder="연락처를 입력해주세요." value="${sessionScope.loginMember.m_phone}" maxlength="11"></div>
